...
type Template = Doc<"events">["certificate"];

/** A fake registration so the designer always has something to preview. */
function previewRegistration(): Doc<"registrations"> {
  return {
    _id: "preview_reg_000000" as any,
    _creationTime: Date.now(),
    eventId: "events_preview" as any,
    userId: "users_preview" as any,
    type: "individual",
    teamName: undefined,
...
export default function OrgCertificate() {
  ...
  const patch = (next: Partial<NonNullable<Template>>) => {
